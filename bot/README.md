...
[![Deploy to Azure][Deploy Button]][Deploy Node/RewardBots]

[Deploy Button]: https://azuredeploy.net/deploybutton.png
[Deploy Node/RewardBots]: https://azuredeploy.net
...
In RewardBot, we are wrapping the Connector's `listen()` method in order to capture the web application's url. We'll use this url later to create a link to the external form.
